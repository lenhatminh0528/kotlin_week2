...
class GridFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        var mLayoutManager : RecyclerView.LayoutManager = GridLayoutManager(requireContext(),2)
    ...
    class RestaurantAdapter(private var context: Context, private var list: List<Restaurant>):
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            var view = LayoutInflater.from(parent.context).inflate(R.layout.item_grid_layout_restaurant,parent,false)
